...
local upButton = createButton(buttonContainer, "â²", UDim2.new(0, 50, 0, 0), UDim2.new(0, 40, 0, 40), "circle", Color3.fromRGB(100, 100, 100), Color3.fromRGB(255, 255, 255))
local downButton = createButton(buttonContainer, "â¼", UDim2.new(0, 100, 0, 0), UDim2.new(0, 40, 0, 40), "circle", Color3.fromRGB(100, 100, 100), Color3.fromRGB(255, 255, 255))
...
local visibilityButton = createButton(buttonContainer, "ð", UDim2.new(0, 200, 0, 0), UDim2.new(0, 40, 0, 40), "circle", Color3.fromRGB(147, 112, 219), Color3.fromRGB(255, 255, 255))
